...
export const metadata: Metadata = {
  ...
  description:
    "Ryan Meetup is partnering up with the Ryan Callahan Foundation to raise money for pediatric cancer care.",
  keywords: [
    "ryan meetup charity",
    "ryan meetup",
    "ryan callahan foundation",
    "ryan meetup ryan callahan",
    "ryan meetup donate",
    "ryan meetup charity effort",
    "ryans giving back",
    "ryans donate",
    "ryan cancer",
