...
const Toast = (props: ToastProps) => {
  ...
  return (
    <div className={`${className} mt-10 absolute z-50 bottom-50`}>
      <Transition
        show={open}
      ...
      >
        <div
          className='flex items-center w-full max-w-sm p-4 text-white rounded-lg bg-black shadow border border-gray-700'
          role='alert'
        >
