...
const Legend = (props: LegendProps) => {
  ...
  return (
    <div className="absolute bottom-2 right-2 w-44 lg:bottom-8 lg:right-8 lg:w-52">
      <div className="rounded-2xl border border-black/10 bg-white/95 p-3 shadow-sm dark:border-white/30 dark:bg-black dark:shadow-xl lg:p-4">
        <Heading
          className="mb-2 text-sm font-semibold text-black dark:text-white/90 lg:text-base"
          size="h3"
        >
          Legend
        </Heading>
