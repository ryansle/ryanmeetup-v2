...
const Event = (props: EventProps) => {
  ...
  return (
    <NextLink href={href}>
      <div className='border border-gray-400 relative bg-white dark:bg-black dark:border-gray-700 rounded-3xl flex flex-col h-full overflow-hidden break-inside-avoid-column transition ease-in duration-300 hover:border-black dark:hover:border-white hover:scale-102'>
        {isPartnerEvent && (
