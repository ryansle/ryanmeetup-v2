...
const Event = (props: EventProps) => {
  ...
  return (
    <NextLink href={href}>
      <div className='border border-gray-400 relative dark:border-gray-700 rounded-3xl flex flex-col h-full overflow-hidden break-inside-avoid-column transition ease-in duration-300 dark:hover:border-white hover:scale-102'>
        {isPartnerEvent && (
